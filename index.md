...
venue: "National Hellenic Research Foundation"        # brief name of host site without address (e.g., "Euphoric State University")
address: "48 Leoforos Vasileos Konstantinou, 116 35 Athens, Greece"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "gr"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "37.973198, 23.745407"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
humandate: "June 3-4, 2019"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "08:00 am - 17:00 pm"    # human-readable times for the workshop (e.g., "9:00 am - 4:30 pm")
...
instructor: ["Thor Wikfeldt", "Fotis E. Psomopouolos"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["TBC"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["kthw@kth.se", "fpsom@certh.gr"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
collaborative_notes: https://pad.carpentries.org/2019-06-03-elixir-athens-eie            # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document
eventbrite: 56572115721          # optional: alphanumeric key for Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
---
...
<div class="partner-logos">
  ...
  <a href="http://eie.gr/" title="National Hellenic Research Foundation, Greece">
    <img style="margin-right:50px" alt="NHRF" src="fig/nhrf_logo.png" width="150"/>
  </a>
...
To report any CoC related concerns or incidents, please use this [incident reporting form](https://goo.gl/forms/KoUfO53Za3apOuOK2). You are welcome to contact Malvika Sharan (deputy chair of CoC) by emailing (malvikasharan@gmail.com) who will be available to address your inquiries, or directly write an email to the Code of Conduct Committee (coc@carpentries.org).  
</p>
